...
const fetchData = async () => {
  waiting.value = true
  try {
    const ret = await axiosIns.get("lidahbuaya/invoices", {
      params: { ...args },
    })
...
const exportAndDownload = async () => {
  ...
  try {
    const response = await axiosIns.post('/lidahbuaya/invoices/export/xml', { doc_key: selectedItem.value },
      {
        headers: {
          responseType: 'blob', 
        },
...
const synchHandler = async () => {
  waiting.value = true
  try {
    await axiosIns.post('/lidahbuaya/invoices', {})
    await fetchData()
  } catch (error) {
...
const downloadTemplate = async () => {
  ...
  try {
    const response = await axiosIns.get('/export/excel/lb', {
      responseType: 'blob', 
      params: {
