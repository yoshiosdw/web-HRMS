...
const fetchData = async () => {
  waiting.value = true
  try {
    const ret = await axiosIns.get("linus/invoices", {
      params: { ...args },
    })
...
const exportAndDownload = async () => {
  ...
  try {
    const response = await axiosIns.post('/linus/invoices/export/xml', { doc_key: selectedItem.value },
      {
        headers: {
          responseType: 'blob', 
        },
...
const synchHandler = async () => {
  waiting.value = true
  try {
    await axiosIns.post('/linus/invoices', {})
    await fetchData()
  } catch (error) {
...
const downloadTemplate = async () => {
  ...
  try {
    const response = await axiosIns.get('/export/excel/linus', {
      responseType: 'blob', 
      params: {
