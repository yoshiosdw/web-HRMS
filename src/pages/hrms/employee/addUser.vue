...
const password_confirmation = ref('Lbg@1080*')
...
watch(() => props.employee, (val) => {
  if (val) {
    ...
    username.value = val.identity_number
  }
})
</script>
        ...
        <VCardText>
          <VRow>
            <VCol cols="12">
              <VTextField
                label="Employee"
                :model-value="props.employee?.name"
                readonly
          ...
          <VRow>
            ...
            <VCol cols="6">
              <VTextField
                ...
                :error-messages="errors.password"
                :append-inner-icon="
                  isConfPasswordVisible ? 'tabler-eye-off' : 'tabler-eye'
                "
                @click:append-inner="
